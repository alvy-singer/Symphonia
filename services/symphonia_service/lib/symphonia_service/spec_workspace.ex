defmodule SymphoniaService.SpecWorkspace do
  ...
  def create_artifact(repository, type, attrs), do: Store.create_artifact(repository, type, attrs)

  def create_artifact(repository, type, id, attrs),
    do: Store.create_artifact(repository, type, id, attrs)
end
